...
YOLO_PATH = os.path.join(HOME,"yolo_dataset","runs","labs","all","weights","best.pt")
...
def main(argv):
    ...
    for dist in distances:
        for angle in angles:
            target_path = os.path.join(PKG_PATH,"dataset","experiment2",str(dist)+"meter",str(angle)+"degree")
