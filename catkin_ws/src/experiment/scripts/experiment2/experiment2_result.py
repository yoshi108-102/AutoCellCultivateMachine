...
def main():
    data = os.path.join(PKG_PATH, "analysis", "experiment2_2_dish.yaml")
    ...
    for dist in distance:
        ...
        for angle in angles:
            ...
            try:
                ...
                real_points[0] = base[0] - real_points[0]
                real_points[1] = -(real_points[1] - base[1])
                """  plt.scatter(data_points[0], data_points[1], color="blue")
                plt.scatter(real_points[0], real_points[1], color="red") """
                diff_angle = [
                    (data_points[i] - real_points[i]) ** 2 for i in range(2)
                ]
                print(diff_angle)
    ...
    plt.savefig(os.path.join(PKG_PATH, "analysis", "experiment2_dish_data.png"))
