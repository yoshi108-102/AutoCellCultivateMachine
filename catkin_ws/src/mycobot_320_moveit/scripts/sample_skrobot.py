...
from skrobot.interfaces.ros.mycobot import MyCobotROSRobotInterface
...
robot_b_model.load_urdf_from_robot_description(
    namespace + "/robot_description"
)
...
robot_a_ri.angle_vector(robot_a_model.angle_vector(), 3)  # robot_aの実機(gazeboも)に指令を送る
