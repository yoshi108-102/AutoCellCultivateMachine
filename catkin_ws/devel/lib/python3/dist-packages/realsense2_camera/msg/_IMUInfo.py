...
"""
    ...
    def __init__(self, *args, **kwds):
        ...
        if args or kwds:
            ...
            if self.noise_variances is None:
                self.noise_variances = [0.0] * 3
            if self.bias_variances is None:
                self.bias_variances = [0.0] * 3
        else:
            self.frame_id = ""
            self.data = [0.0] * 12
            self.noise_variances = [0.0] * 3
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.noise_variances = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=3
            )
            start = end
            end += 24
            self.bias_variances = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=3
            )
            return self
        except struct.error as e:
