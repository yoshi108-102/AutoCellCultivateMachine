...
"""autogenerated by genpy from denso_cobotta_gripper/GripperMoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class GripperMoveActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "denso_cobotta_gripper/GripperMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','denso_cobotta_gripper/GripperMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GripperMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = denso_cobotta_gripper.msg.GripperMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = denso_cobotta_gripper.msg.GripperMoveResult()
