...
"""autogenerated by genpy from denso_cobotta_gripper/VacuumMoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class VacuumMoveActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "denso_cobotta_gripper/VacuumMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','denso_cobotta_gripper/VacuumMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VacuumMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = denso_cobotta_gripper.msg.VacuumMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = denso_cobotta_gripper.msg.VacuumMoveResult()
