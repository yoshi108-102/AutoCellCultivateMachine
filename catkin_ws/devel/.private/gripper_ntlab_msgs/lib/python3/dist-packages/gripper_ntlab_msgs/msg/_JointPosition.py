...
"""autogenerated by genpy from gripper_ntlab_msgs/JointPosition.msg. Do not edit."""
import codecs
import sys
...
class JointPosition(genpy.Message):
  _md5sum = "42665b9cfa738929ee7f26a4db0bd85b"
  _type = "gripper_ntlab_msgs/JointPosition"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64[] position
uint8 mode
"""
  __slots__ = ['position','mode']
